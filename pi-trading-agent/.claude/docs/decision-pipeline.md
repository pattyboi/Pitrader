...
5. **Signals/memory** — batch backfill/update pooled memory, apply posture plus aggregate/per-symbol news, enforce raw dip/observation/profit/OOS/learned-edge floors, sort, and write the dashboard snapshot.
